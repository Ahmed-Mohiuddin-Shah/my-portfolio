...
interface Item {
  id: number | string; // Ensure id can be a string for consistency
  name: string;
  description: string;
  language: string;
  img: string;
                    ...
                    grid
                      .filter((item, idx) => {
                        ...
                        for (let i = 0; i <= idx; i++) {
                          ...
                          if (i === idx && c === col) found = true;
                          colHeights[c] += grid[i].h + 16;
                        }
                        return found;
                      })
                      .reduce((acc, item) => acc + item.h + 16, -16) // -16 to remove last gap
                )
              )
            : 0,
      }}
    >
      {grid.map((item) => (
        ...
        >
          ...
          >
            <div className="absolute bottom-0 left-0 right-0 p-2 bg-[#99b3ff] bg-opacity-50 rounded-b-[10px]">
